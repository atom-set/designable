import { IconWidget, usePrefix } from "@designer/react";
...
export const FlexStyleSetter: React.FC<
  React.PropsWithChildren<IFlexStyleSetterProps>
> = observer((props) => {
    ...
    <div className={cls(prefix, props.className)} style={props.style}>
      <InputItems vertical>
        ...
        <Field
          ...
          reactions={(field) => {
            (field.decorator as any)[1].title = `Justify Content : ${field.value || ""
              }`;
          }}
          decorator={[InputItems.Item]}
          component={[Radio.Group, { optionType: "button" }]}
