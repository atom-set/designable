import { GlobalRegistry, TreeNode } from "@designer/core";
...
export const TreeNodeWidget: React.FC<
  React.PropsWithChildren<ITreeNodeWidgetProps>
> = observer((props: ITreeNodeWidgetProps) => {
...
export const ComponentTreeWidget: React.FC<
  React.PropsWithChildren<IComponentTreeWidgetProps>
