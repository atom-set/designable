...
import { isFn } from "@designer/shared";
...
export const OutlineTreeNode: React.FC<
  React.PropsWithChildren<IOutlineTreeNodeProps>
> = observer(({ node, className, style, workspaceId }) => {
