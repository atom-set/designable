    ...
    ;(t.WorkspaceChange = T),
      ...
      (function (e) {
        ;(e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e
            return t && k.string(t.newText) && o.is(t.insert) && o.is(t.replace)
          })
                    ...
                    if (void 0 !== u) {
                      ...
                      if (m.schema.properties)
                        (S = m.schema.properties[u]) &&
                          ((v = !0), this.addSchemaValueCompletions(S, d, a, s))
      ...
      return (
        ...
        (e.prototype.getMatchingSchemas = function (e, t, n) {
          if (n) {
            ...
            return this.resolveSchemaContent(new l(n), r, {}).then(function (
              e
            ) {
