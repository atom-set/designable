...
import { DatePickerLocal } from '../Base/locales'

export const TimePickerLocales = createLocales(DatePickerLocal, {
  'zh-CN': {
    title: '时间选择',
    settings: {
      'x-component-props': {
...
export const TimeRangePickerLocales = createLocales(TimePickerLocales, {
  'zh-CN': {
    title: '时间范围',
  },
  'en-US': {
